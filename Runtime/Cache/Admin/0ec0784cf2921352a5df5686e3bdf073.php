 ...
 <body>
	...
	<div id="container">
		...
		<div class="operate">
			...
			<a class="btn btn-info" href="<?php echo U('Post/trash');?>">回收站</a>
		 	...
		 	<table>
		 		...
		 		<tbody>
		 			<?php if(is_array($posts)): foreach($posts as $k=>$vo): ?><tr id="post-<?php echo ($vo['post_id']); ?>">
							...
							<th class="column-date"><?php echo (date('Y-m-d h:i:s',$vo["post_date"])); ?></th>
							<th class="column-modified"><?php echo (date('Y-m-d h:i:s',$vo["post_modified"])); ?></th>

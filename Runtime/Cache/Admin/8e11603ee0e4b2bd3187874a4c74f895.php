		...
		<div class="operate">
			<!-- <form action="" method="post"> -->
				...
				<div class="option">
					<div class="post_cate">
						<ul>
						<!-- <a href="" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">增加分类</a> -->
							<?php if(is_array($my_categories)): foreach($my_categories as $k=>$vo): ?><li>
									<?php echo ($vo["category_name"]); ?>
									<a class="del-cate" cate2del="<?php echo ($vo["relation_id"]); ?>">X</a>
